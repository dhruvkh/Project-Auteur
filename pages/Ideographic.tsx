    ...
    <PageWrapper>
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center bg-panel-muted text-ink text-center px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl">
          <h1 className="text-6xl md:text-7xl font-bold tracking-wider mb-6">Ideographic</h1>
      ...
      <section className="py-20 bg-paper">
        <div className="container mx-auto px-6">
          <h2 className="text-5xl font-bold text-center mb-4 text-ink">What We Do</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {IDEOGRAPHIC_SERVICES.map((service, index) => (
              <div key={index} className="p-8 border-2 border-panel-dark hover:border-primary transition-colors duration-300">
                <h3 className="text-3xl font-bold text-ink mb-4">{service.title}</h3>
            ...
            <div className="md:col-span-2 lg:col-span-1 p-8 bg-primary/10 border-2 border-primary flex flex-col justify-center items-center text-center">
              <h3 className="text-3xl font-bold text-ink mb-4">Ready to tell your story?</h3>
              <Link to="/contact">
      ...
      <section className="py-20 bg-panel-muted">
        <div className="container mx-auto px-6 text-center">
            <h2 className="text-5xl font-bold mb-12 text-ink">Our Process</h2>
            <div className="grid md:grid-cols-3 gap-12 max-w-5xl mx-auto">
                <div className="flex flex-col items-center">
                    <div className="text-4xl font-bold text-primary mb-2">01</div>
                    <h3 className="text-2xl font-bold text-ink mb-2">Discovery</h3>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <h3 className="text-2xl font-bold text-ink mb-2">Design</h3>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <h3 className="text-2xl font-bold text-ink mb-2">Dispatch</h3>
